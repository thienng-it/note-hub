...
export function EditProfilePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-start justify-center page-padding py-6">
                  ...
                  <button
                    ...
                    className={`px-4 py-3 rounded-lg border-2 transition-all ${
                      formData.status === status
                        ? 'border-blue-500 bg-blue-50 dark:!bg-blue-600 dark:!border-blue-500 text-blue-700 dark:!text-white'
                        : 'border-[var(--border-color)] bg-[var(--bg-primary)] hover:border-blue-300 text-[var(--text-secondary)]'
                    }`}
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      />
                      <span className="text-sm font-medium">{t(`chat.${status}`)}</span>
                    </div>
                  </button>
                ))}
              </div>
