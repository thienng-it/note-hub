...
export function NotesPage() {
  ...
  return (
    <div className="flex gap-4 sm:gap-6 p-4 sm:p-6 lg:p-8 page-padding">
      ...
      {/* Desktop Folder Sidebar - Enhanced */}
      <div className="w-72 flex-shrink-0 hidden lg:block">
        <div className="modern-sidebar sticky top-6">
          <div className="sidebar-header">
            <i className="fas fa-folder-tree text-blue-500"></i>
            <span>{t('folders.title') || 'Folders'}</span>
          </div>
          <FolderTree
            folders={folders}
            selectedFolderId={selectedFolder?.id}
