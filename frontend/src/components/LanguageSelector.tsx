...
export function LanguageSelector() {
  ...
  return (
    <div className="relative group">
      ...
      {/* Dropdown Menu */}
      <div className="absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-[var(--bg-primary)] border border-gray-200 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
        <div className="py-1">
