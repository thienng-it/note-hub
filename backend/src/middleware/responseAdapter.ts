 ...
 */
export function markAsV1(_req: Request, res: Response, next: NextFunction): void {
 ...
 */
export function legacyResponseAdapter(_req: Request, res: Response, next: NextFunction): void {
