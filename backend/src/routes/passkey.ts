 ...
 */
router.post('/register-options', jwtRequired, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/register-verify', jwtRequired, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/credentials', jwtRequired, async (req: Request, res: Response) => {
  try {
