 ...
 */
router.get('/validate', jwtRequired, (req: Request, res: Response) => {
  return responseHandler.success(
    res,
    {
      valid: true,
 ...
 */
router.post('/logout', jwtRequired, async (req: Request, res: Response) => {
  try {
    const { refresh_token } = req.body;
 ...
 */
router.post('/logout-all', jwtRequired, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/sessions', jwtRequired, async (req: Request, res: Response) => {
  try {
